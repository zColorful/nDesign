...
export type IButtonColor = 'secondary' | 'primary' | 'success' | 'waiting' | 'warning' | 'danger';
...
export const buttonGroupInjectionKey: InjectionKey<ButtonGroupInjection> = Symbol('n-button-group');

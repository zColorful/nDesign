...
export default defineComponent({
  ...
  setup(props: ColorPickerProps, { emit }) {
    ...
    return () => {
      return (
        <div class="nancalui-color-picker-panel">
          <n-tabs v-model={tab.value}>
            <n-tab id="basic" title={t('foundationPanel')} tabId="basic">
              <color-basic color={paletteColorMap}></color-basic>
            </n-tab>
            <n-tab id="palette" title={t('advancedPanel')} tabId="palette">

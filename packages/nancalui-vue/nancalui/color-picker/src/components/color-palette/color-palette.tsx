...
export default defineComponent({
  ...
  emits: ['update:modelValue', 'changeTextColor', 'change'],
  setup(props: ColorPickerPaletteProps, ctx) {
    ...
    return () => {
      return (
        <div class="nancalui-color-picker-palette" ref={paletteElement} onClick={clickPalette}>
          <canvas ref={canvasElement}></canvas>
          <div class="nancalui-color-picker-palette-handler" style={getCursorStyle.value}>

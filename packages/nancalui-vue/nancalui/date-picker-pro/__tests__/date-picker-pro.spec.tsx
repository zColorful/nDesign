...
import NDatePickerPro from '../src/date-picker-pro';
  ...
  it('date-picker-pro init render', async () => {
    ...
    const wrapper = mount({
      setup() {
        ...
        return () => <NDatePickerPro v-model={datePickerProValue.value} placeholder="请选择日期"></NDatePickerPro>;
      },
    });
  ...
  it('date-picker-pro format props', async () => {
    ...
    const wrapper = mount({
      setup() {
        const app = getCurrentInstance();
        app.appContext.config.globalProperties.langMessages = ref(Locale.messages());
        return () => <NDatePickerPro v-model={datePickerProValue.value} format="YYYY-MM-DD" placeholder="请选择日期"></NDatePickerPro>;
      },
    });
  ...
  it('date-picker-pro showTime props', async () => {
    ...
    const wrapper = mount({
      setup() {
        const app = getCurrentInstance();
        app.appContext.config.globalProperties.langMessages = ref(Locale.messages());
        return () => <NDatePickerPro v-model={datePickerProValue.value} showTime={true} placeholder="请选择日期"></NDatePickerPro>;
      },
    });
      ...
      setup() {
        ...
        return () => (
          <NDatePickerPro
            ...
            onFocus={onFocus}
            onBlur={onBlur}
            placeholder="请选择日期"></NDatePickerPro>
        );
      },
    });
  ...
  it('date-picker-pro size test', async () => {
    ...
    const wrapper = mount({
      setup() {
        const app = getCurrentInstance();
        app.appContext.config.globalProperties.langMessages = ref(Locale.messages());
        return () => <NDatePickerPro v-model={datePickerProValue.value} size="lg" placeholder="请选择日期"></NDatePickerPro>;
      },
    });
    const container = wrapper.find(baseClass);
  ...
  it('date-picker-pro disabled', async () => {
    ...
    const wrapper = mount({
      setup() {
        const app = getCurrentInstance();
        app.appContext.config.globalProperties.langMessages = ref(Locale.messages());
        return () => <NDatePickerPro v-model={datePickerProValue.value} placeholder="请选择日期" disabled={true}></NDatePickerPro>;
      },
    });

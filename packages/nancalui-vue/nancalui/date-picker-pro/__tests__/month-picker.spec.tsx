  ...
  it('year picker init render and select year', async () => {
    ...
    const wrapper = mount({
      setup() {
        ...
        return () => <NDatePickerPro v-model={datePickerProValue.value} type="month"></NDatePickerPro>;
      },
    });
  ...
  it('year range picker init render and select year', async () => {
    ...
    const wrapper = mount({
      setup() {
        const app = getCurrentInstance();
        app.appContext.config.globalProperties.langMessages = ref(Locale.messages());
        return () => <NRangeDatePickerPro v-model={datePickerProValue.value} type="month"></NRangeDatePickerPro>;
      },
    });

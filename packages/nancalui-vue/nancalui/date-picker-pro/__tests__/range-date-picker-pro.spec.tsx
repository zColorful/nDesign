  ...
  it('range-date-picker-pro init render', async () => {
    ...
    const wrapper = mount({
      setup() {
        ...
        return () => <NRangeDatePickerPro v-model={datePickerProValue.value}></NRangeDatePickerPro>;
      },
    });
      ...
      setup() {
        ...
        return () => (
          <NRangeDatePickerPro
            ...
            onFocus={onFocus}
            onBlur={onBlur}></NRangeDatePickerPro>
        );
      },
    });
  ...
  it('range-date-picker-pro size test', async () => {
    ...
    const wrapper = mount({
      setup() {
        const app = getCurrentInstance();
        app.appContext.config.globalProperties.langMessages = ref(Locale.messages());
        return () => <NRangeDatePickerPro v-model={datePickerProValue.value} size="lg"></NRangeDatePickerPro>;
      },
    });
    const container = wrapper.find(baseClass);
        ...
        return () => (
          <NRangeDatePickerPro
            ...
            v-slots={{
              footer: () => (
                <div>
                  <n-button variant="solid" color="secondary" onClick={setToday}>
                    今天
                  </n-button>
                </div>
              ),
      ...
      setup() {
        ...
        return () => (
          <NRangeDatePickerPro
            ...
            limitDateRange={limitDateRange.value}></NRangeDatePickerPro>
        );
      },
    });
    const container = wrapper.find(baseClass);
  ...
  it('range-date-picker-pro disabled', async () => {
    ...
    const wrapper = mount({
      setup() {
        const app = getCurrentInstance();
        app.appContext.config.globalProperties.langMessages = ref(Locale.messages());
        return () => <NRangeDatePickerPro v-model={datePickerProValue.value} disabled={true}></NRangeDatePickerPro>;
      },
    });

...
import NTable from '../src/table';
import NColumn from '../src/components/column/column';
...
describe('n-table', () => {
  ...
  it('table render correctly', async () => {
    const wrapper = mount({
      setup() {
        return () => (
          <NTable data={data}>
            <NColumn field="firstName" header="First Name"></NColumn>
            <NColumn field="lastName" header="Last Name"></NColumn>
            <NColumn field="gender" header="Gender"></NColumn>
            <NColumn field="date" header="Date of birth"></NColumn>
          </NTable>
        );
      },
    });
  ...
  it('checkable column', async () => {
    const wrapper = mount({
      setup() {
        return () => (
          <NTable data={data}>
            <NColumn type="checkable"></NColumn>
            <NColumn field="firstName" header="First Name"></NColumn>
            <NColumn field="lastName" header="Last Name"></NColumn>
            <NColumn field="gender" header="Gender"></NColumn>
            <NColumn field="date" header="Date of birth"></NColumn>
  ...
  it('column default slots', async () => {
    const wrapper = mount({
      setup() {
        return () => (
          <NTable data={data}>
            <NColumn type="index">{{ default: (scope) => `No.${scope.rowIndex + 1}` }}</NColumn>
            <NColumn field="firstName" header="First Name"></NColumn>
            <NColumn field="lastName" header="Last Name"></NColumn>
            <NColumn field="gender" header="Gender"></NColumn>
            <NColumn field="date" header="Date of birth"></NColumn>
  ...
  it('column header slots', async () => {
    const wrapper = mount({
      setup() {
        return () => (
          <NTable data={data}>
            <NColumn type="index">{{ header: () => '序号' }}</NColumn>
            <NColumn field="firstName" header="First Name"></NColumn>
            <NColumn field="lastName" header="Last Name"></NColumn>
            <NColumn field="gender" header="Gender"></NColumn>
            <NColumn field="date" header="Date of birth"></NColumn>
  ...
  it('merge cell', async () => {
    const wrapper = mount({
      setup() {
        ...
        return () => (
          <NTable data={data} span-method={spanMethod}>
            <NColumn field="firstName" header="First Name"></NColumn>
            <NColumn field="lastName" header="Last Name"></NColumn>
            <NColumn field="gender" header="Gender"></NColumn>
            <NColumn field="date" header="Date of birth"></NColumn>
  ...
  it('sort', async () => {
    ...
    const wrapper = mount({
      setup() {
        ...
        return () => (
          <NTable data={data} onSortChange={handleSortChange}>
            <NColumn field="firstName" header="First Name"></NColumn>
            <NColumn field="lastName" header="Last Name"></NColumn>
            <NColumn field="gender" header="Gender"></NColumn>
            <NColumn field="date" header="Date of birth" sortable sort-direction="ASC" sort-method={sortDateMethod}></NColumn>
          </NTable>
        );
      },
    });
        ...
        return () => (
          <NTable data={data}>
            ...
            <NColumn
              ...
              onFilterChange={handleSingleChange}></NColumn>
            <NColumn field="date" header="Date of birth"></NColumn>
          </NTable>
        );
      },
      ...
      setup() {
        return () => (
          <NTable data={data}>
            ...
            <NColumn field="lastName" header="Last Name"></NColumn>
            <NColumn field="gender" header="Gender"></NColumn>
            <NColumn field="date" header="Date of birth" align="right"></NColumn>
          </NTable>
        );
      },
    });
  ...
  it('cell click event', async () => {
    ...
    const wrapper = mount({
      setup() {
        return () => (
          <NTable data={data} onCellClick={onCellClick}>
            <NColumn field="firstName" header="First Name"></NColumn>
            <NColumn field="lastName" header="Last Name"></NColumn>
            <NColumn field="gender" header="Gender"></NColumn>
            <NColumn field="date" header="Date of birth"></NColumn>
  ...
  it('show header api', async () => {
    ...
    const wrapper = mount({
      setup() {
        return () => (
          <NTable data={data} show-header={showHeader.value}>
            <NColumn field="firstName" header="First Name"></NColumn>
            <NColumn field="lastName" header="Last Name"></NColumn>
            <NColumn field="gender" header="Gender"></NColumn>
            <NColumn field="date" header="Date of birth"></NColumn>
      ...
      setup() {
        ...
        return () => (
          <div>
            ...
            <NTable ref={tableRef} data={data} row-key="firstName" expand-row-keys={['Jacob', 'Mark']}>
              <NColumn type="expand"></NColumn>
              <NColumn type="checkable" width="40" checkable={checkable} reserve-check></NColumn>
              <NColumn field="firstName" header="First Name"></NColumn>
              <NColumn field="lastName" header="Last Name"></NColumn>
              <NColumn field="gender" header="Gender"></NColumn>
              <NColumn field="date" header="Date of birth"></NColumn>
  ...
  it('table tree test work', async () => {
    const wrapper = mount({
      setup() {
        ...
        return () => (
          <div>
            <NTable indent={32} data={baseTreeTableData} row-key="firstName">
              <NColumn type="index"></NColumn>
              <NColumn field="firstName" header="First Name" show-overflow-tooltip></NColumn>
              <NColumn field="lastName" header="Last Name"></NColumn>
              <NColumn field="gender" header="Gender"></NColumn>
              <NColumn field="date" header="Date of birth"></NColumn>
            </NTable>
  ...
  it('table edit cell work', async () => {
    const wrapper = mount({
      setup() {
        ...
        return () => (
          <div>
            <NTable ref={tableRef} data={baseTreeTableData.value} row-key="id" onCellClick={cellClick}>
              <NColumn
                field="firstName"
                header="First Name"
                type="editable"
    ...
    const wrapper = mount({
      setup() {
        const handleLoadMore = () => {
          ...
          // The 'intersection-observer' polyfill don't work in Jest env? It's just prevent error report in NTable.
          data.push({
            firstName: 'loadMore',
            lastName: 'loadMore',
            gender: 'Female',
        ...
        return () => (
          <NTable data={data} table-height="100px" lazy={true} onLoadMore={handleLoadMore}>
            <NColumn field="firstName" header="First Name"></NColumn>
            <NColumn field="lastName" header="Last Name"></NColumn>
            <NColumn field="gender" header="Gender"></NColumn>
            <NColumn field="date" header="Date of birth"></NColumn>

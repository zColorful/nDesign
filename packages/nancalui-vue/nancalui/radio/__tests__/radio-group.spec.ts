...
describe('RadioGroup', () => {
  it('radioGroup render work', async () => {
    ...
    const wrapper = mount({
      ...
      template: `
        <n-radio-group v-model="radioVal" @change="onChange">
          <n-radio value="Item1">Item1</n-radio>
          <n-radio value="Item2">Item2</n-radio>
        </n-radio-group>
      `,
      setup() {
  ...
  it('radioGroup beforeChange work', async () => {
    ...
    const wrapper = mount({
      ...
      template: `
        <n-radio-group v-model="radioVal" @change="onChange" :before-change="beforeChange">
          <n-radio value="Item1">Item1</n-radio>
          <n-radio value="Item2">Item2</n-radio>
          <n-radio value="Item3">Item3</n-radio>
        </n-radio-group>
      `,
      setup() {
        const radioVal = ref('Item1');
  ...
  it('radioGroup disabled work', async () => {
    ...
    const wrapper = mount({
      ...
      template: `
        <n-radio-group v-model="radioVal" @change="onChange">
          <n-radio value="Item1">Item1</n-radio>
          <n-radio value="Item2" disabled>Item2</n-radio>
        </n-radio-group>
      `,
      setup() {
        const radioVal = ref('Item1');
  ...
  it('radioGroup size border work', async () => {
    const wrapper = mount({
      ...
      template: `
        <n-radio-group v-model="radioVal" size="lg" :border="border">
          <n-radio value="Item1">Item1</n-radio>
          <n-radio value="Item2" disabled>Item2</n-radio>
        </n-radio-group>
      `,
  ...
  it('radio-button fill text-color', async () => {
    ...
    const wrapper = mount({
      ...
      template: `
        <n-radio-group v-model="choose" fill="red" text-color="rgb(204,204,204)">
          <n-radio-button value="a">1</n-radio-button>
          <n-radio-button value="b">2</n-radio-button>
        </n-radio-group>
      `,
      setup() {
        return {

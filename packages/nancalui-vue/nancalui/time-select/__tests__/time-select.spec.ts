...
import NTimeSelect from '../src/time-select';
...
describe('TimeSelect', () => {
  ...
  it('time-select render work', async () => {
    const wrapper = mount({
      components: { NTimeSelect },
      template: `<n-time-select v-model="modelValue" step="01:00" start="01:00" end="23:00"></n-time-select>`,
      setup() {
  ...
  it('time-select size work', async () => {
    const wrapper = mount({
      components: { NTimeSelect },
      template: `<n-time-select v-model="modelValue" size="sm"></n-time-select>`,
      setup() {
  ...
  it('time-select disabled work', async () => {
    const wrapper = mount({
      components: { NTimeSelect },
      template: `<n-time-select v-model="modelValue" disabled></n-time-select>`,
      setup() {
        const modelValue = ref('00:30');
        return {
          modelValue,
  ...
  it('time-select clear work', async () => {
    const wrapper = mount({
      components: { NTimeSelect },
      template: `<n-time-select v-model="modelValue" clearable></n-time-select>`,
      setup() {
        const modelValue = ref('00:30');
        return {
          modelValue,
  ...
  it('time-select events work', async () => {
    ...
    const wrapper = mount({
      components: { NTimeSelect },
      template: `<n-time-select v-model="modelValue" @change="onChange" @focus="onFocus" @blur="onBlur"></n-time-select>`,
      setup() {
        const modelValue = ref('00:30');
        return {
          modelValue,
  ...
  it('time-select step work', async () => {
    const wrapper = mount({
      components: { NTimeSelect },
      template: `<n-time-select v-model="modelValue" start="01:00" end="23:00"></n-time-select>`,
      setup() {
  ...
  it('time-select start/end work', async () => {
    const wrapper = mount({
      components: { NTimeSelect },
      template: `<n-time-select v-model="modelValue" step="00:10"></n-time-select>`,
      setup() {
        const modelValue = ref('');
        return {
          modelValue,
  ...
  it('time-select min-time/max-time work', async () => {
    const wrapper = mount({
      components: { NTimeSelect },
      template: `<n-time-select v-model="modelValue" max-time="18:30"></n-time-select>`,
      setup() {
        const modelValue = ref('');
        return {
          modelValue,
  ...
  it('time-select placeholder work', async () => {
    const wrapper = mount({
      components: { NTimeSelect },
      template: `<n-time-select v-model="modelValue" placeholder="测试placeholder是否正常渲染"></n-time-select>`,
      setup() {
        const modelValue = ref('');
        return {
          modelValue,

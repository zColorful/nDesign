...
describe('Tabs', () => {
  ...
  it('addable & closeable work', async () => {
    wrapper = mount({
      ...
      template: `
        <n-tabs v-model="editableId" closeable addable @tabAdd="tabAdd" @tabRemove="tabRemove">
          <n-tab v-for="tab in tabs" :key="tab.id" :id="tab.id" :title="tab.title">
  ...
  it('"tab-change" work', async () => {
    ...
    wrapper = mount({
      ...
      template: `
        <n-tabs v-model="editableId" addable @tab-change="onTabChange">
          <n-tab v-for="tab in tabs" :key="tab.id" :id="tab.id" :title="tab.title">
            <p>{{ tab.title }} Content</p>
          </n-tab>
        </n-tabs>
    ...
    wrapper = mount({
      ...
      template: `
        <n-tabs>
          ...
          <n-tab id="tab2" title="Tab2">Tab2 Content</n-tab>
          <n-tab id="tab3" title="Tab3">Tab3 Content</n-tab>
        </n-tabs>
      `,
    });

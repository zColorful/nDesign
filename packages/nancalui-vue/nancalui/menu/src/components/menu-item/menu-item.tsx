...
export default defineComponent({
  name: 'NMenuItem',
  props: menuItemProps,
  setup(props: MenuItemProps, ctx: any) {
    ...
    const defaultSelectKey = inject('defaultSelectKey') as any;
    ...
    const classObject = computed(() => ({
      ...
      collapsedSpan: isCollapsed.value,
      normalSpan: !isCollapsed.value,
    }));
    ...
    const onClick = (e: MouseEvent) => {
      ...
      if (mode.value === 'vertical' && isCollapsed.value) {
    ...
    watch(
      ...
      (n) => {
        isSelect.value = initSelect(defaultSelectKey, key, multiple, disabled);
    ...
    return () => {
      return mode.value === 'vertical' ? (
        <div class={`${ns.b()}-item-vertical-wrapper ${isCollapsed.value ? 'isCollapsed' : ''}`}>
          <li class={classObject.value} onClick={onClick} ref={menuItems} style="height:auto">

import { defineComponent, provide, ref, computed, onMounted, toRefs, reactive, watch } from 'vue';
...
export default defineComponent({
  ...
  setup(props: MenuProps, ctx) {
    ...
    const { openKeys, mode, collapsed, uniqueOpened, defaultSelectKeys } = toRefs(props);
    ...
    provide('uniqueOpened', uniqueOpened);
            ...
            entries.forEach((entry: IntersectionObserverEntry) => {
              if (!entry.isIntersecting) {
                ...
                if (
                  ...
                  if (obItem?.classList.contains('nancalui-submenu')) {
                    const sub = obItem;

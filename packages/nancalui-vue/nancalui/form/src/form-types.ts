...
export type LabelSuffix = '';
export type FormData = Record<string, unknown>;
export type labelWidth = Record<string, 'auto'>;
...
export const FORM_TOKEN: InjectionKey<FormContext> = Symbol('nForm');
...
export interface NFormValidateSubmitData {
...
export interface UseValidate {
  ...
  createnancaluiBuiltinValidator: (rule: FormRules) => void;
}

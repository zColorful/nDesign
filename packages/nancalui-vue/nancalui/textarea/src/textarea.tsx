...
export default defineComponent({
  ...
  setup(props: TextareaProps, ctx: SetupContext) {
    ...
    const { isFocus, textareaDisabled, textareaDisabledBorder, wrapClasses } = useTextareaRender(props);
    ...
    return () => (
      <div style="width: 100%" class={ns.e('div')}>
        <textarea
          ref={textarea}
          {...ctx.attrs}
          ...
          noborder={textareaDisabledBorder.value}

...
import NTimePicker from '../src/time-picker';
...
describe('time-picker test', () => {
  it('time-picker init render', async () => {
    const wrapper = mount({
      ...
      template: `<n-time-picker></n-time-picker>`,
  ...
  it('time-picker default open work', async () => {
    const wrapper = mount({
      components: { NTimePicker },
      template: `<n-time-picker v-model="vModelValue" :time-picker-width="300" autoOpen></n-time-picker>`,
      setup() {
  ...
  it('time-picker min-time work', async () => {
    const wrapper = mount({
      components: { NTimePicker },
      template: `<n-time-picker min-time='01:04:30' v-model="vModelValue"></n-time-picker>`,
      setup() {
  ...
  it('time-picker max-time work', async () => {
    const wrapper = mount({
      components: { NTimePicker },
      template: `<n-time-picker max-time='22:46:20' v-model="vModelValue"></n-time-picker>`,
      setup() {
  ...
  it('time-picker format mm:ss work', async () => {
    const wrapper = mount({
      components: { NTimePicker },
      template: `<n-time-picker v-model="vModelValue" format='mm:ss'></n-time-picker>`,
      setup() {
  ...
  it('time-picker format hh:mm work', async () => {
    const wrapper = mount({
      components: { NTimePicker },
      template: `<n-time-picker v-model="vModelValue" format='hh:mm'></n-time-picker>`,
      setup() {
  ...
  it('time-picker size work', async () => {
    const wrapper = mount({
      components: { NTimePicker },
      template: `<n-time-picker v-model="vModelValue" size="lg"></n-time-picker>`,
      setup() {
        const vModelValue = ref('23:30:20');
        return {
          vModelValue,
  ...
  it('time-picker readonly work', async () => {
    const wrapper = mount({
      components: { NTimePicker },
      template: `<n-time-picker v-model="vModelValue" readonly></n-time-picker>`,
      setup() {
        const vModelValue = ref('23:30:20');
        return {
          vModelValue,
    ...
    const timeInput = wrapper.find<HTMLInputElement>(inputInnerClass);
    await timeInput.trigger('focus');
    expect(wrapper.find('.nancalui-time-popup').exists()).toBeFalsy();

...
export default defineComponent({
  ...
  render() {
    ...
    return (
      <div class="nancalui-quadrant-diagram" id={diagramId}>
        <NQuadrantDiagramAxis diagramId={diagramId} axisConfigs={calAxisConfig} view={view} />
      </div>
    );
  },
});

...
import NStepsGuide from '../src/steps-guide';
export default defineComponent({
  name: 'StepsGuideDemo',
  components: {
    'n-steps-guide': NStepsGuide,
  },
  setup() {
  ...
  render(props){
    return (<>
      ...
      <n-steps-guide ref="stepRef" steps={ props.steps } v-model:step-index={ props.stepIndex }></n-steps-guide></>);
  }
});

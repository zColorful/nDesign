...
import NInputNumber from '../src/input-number';
...
describe('n-input-number', () => {
  it('visible', () => {
    ...
    const wrapper = mount({
      setup() {
        return () => <NInputNumber v-model={num.value}></NInputNumber>;
      },
    });
  ...
  it('disabled', () => {
    ...
    const wrapper = mount({
      setup() {
        return () => <NInputNumber v-model={num.value} disabled></NInputNumber>;
      },
    });
  ...
  it('max min', async () => {
    ...
    const wrapper = mount({
      setup() {
        return () => <NInputNumber v-model={num.value} min={1} max={2}></NInputNumber>;
      },
    });
  ...
  it('step', async () => {
    ...
    const wrapper = mount({
      setup() {
        return () => <NInputNumber v-model={num.value} step={3}></NInputNumber>;
      },
    });
  ...
  it('precision', async () => {
    ...
    const wrapper = mount({
      setup() {
        return () => <NInputNumber v-model={num.value} step={0.1} precision={2}></NInputNumber>;
      },
    });
  ...
  it('size', async () => {
    ...
    const wrapper = mount({
      setup() {
        return () => <NInputNumber v-model={num.value} size="lg"></NInputNumber>;
      },
    });
  ...
  it('regular expression check', async () => {
    ...
    const wrapper = mount({
      setup() {
        ...
        return () => <NInputNumber v-model={num.value} reg={regStr}></NInputNumber>;
      },
    });
  ...
  it('placeholder work', async () => {
    ...
    const wrapper = mount({
      setup() {
        return () => <NInputNumber v-model={num.value} placeholder={placeholderStr}></NInputNumber>;
      },
    });
    const inputNumber = wrapper.find(ns.b());
    expect(inputNumber.exists()).toBeTruthy();

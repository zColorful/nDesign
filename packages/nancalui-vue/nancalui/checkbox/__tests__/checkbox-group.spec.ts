...
describe('n-checkbox-group', () => {
  ...
  it('checkbox-group disabled work', async () => {
    ...
    const wrapper = mount({
      ...
      template: `
        <n-checkbox-group v-model="list" :disabled="disabled" @change="onChange">
          <n-checkbox value="a">1</n-checkbox>
          <n-checkbox value="b">2</n-checkbox>
        </n-checkbox-group>
      `,
      setup() {
        return {
  ...
  it('checkbox-group direction work', async () => {
    ...
    const wrapper = mount({
      ...
      template: `
        <n-checkbox-group v-model="list" :direction="direction">
          <n-checkbox value="a">1</n-checkbox>
          <n-checkbox value="b">2</n-checkbox>
        </n-checkbox-group>
      `,
  ...
  it('checkbox-group itemWidth work', () => {
    ...
    const wrapper = mount({
      ...
      template: `
        <n-checkbox-group v-model="list" :item-width="itemWidth">
          <n-checkbox value="a">1</n-checkbox>
          <n-checkbox value="b">2</n-checkbox>
        </n-checkbox-group>
      `,
  ...
  it('checkbox-group options work', () => {
    ...
    const wrapper = mount({
      ...
      template: `
        <n-checkbox-group v-model="list" :options="options">
        </n-checkbox-group>
      `,
      setup() {
        const options = [
  ...
  it('checkbox-group beforeChange work', async () => {
    ...
    const wrapper = mount({
      ...
      template: `
        <n-checkbox-group v-model="list" :before-change="beforeChange" @change="onChange">
          <n-checkbox value="a">1</n-checkbox>
          <n-checkbox value="b">2</n-checkbox>
        </n-checkbox-group>
      `,
  ...
  it('checkbox-group max work', async () => {
    ...
    const wrapper = mount({
      ...
      template: `
        <n-checkbox-group v-model="list" :max="max">
          <n-checkbox value="a">1</n-checkbox>
          <n-checkbox value="b">2</n-checkbox>
          <n-checkbox value="c">3</n-checkbox>
          <n-checkbox value="d">4</n-checkbox>
        </n-checkbox-group>
      `,
      setup() {
        return {
  ...
  it('checkbox-group border size work', () => {
    ...
    const wrapper = mount({
      ...
      template: `
        <n-checkbox-group v-model="list" border size="lg">
          <n-checkbox value="a">1</n-checkbox>
          <n-checkbox value="b">2</n-checkbox>
        </n-checkbox-group>
      `,
  ...
  it('checkbox-group checkbox-button', async () => {
    ...
    const wrapper = mount({
      ...
      template: `
        <n-checkbox-group v-model="list">
          <n-checkbox-button value="a">1</n-checkbox-button>
          <n-checkbox-button value="b">2</n-checkbox-button>
        </n-checkbox-group>
      `,
      setup() {
        return {
  ...
  it('checkbox-button color text-color', async () => {
    ...
    const wrapper = mount({
      ...
      template: `
        <n-checkbox-group v-model="list" color="red" text-color="rgb(204,204,204)">
          <n-checkbox-button value="a">1</n-checkbox-button>
          <n-checkbox-button value="b">2</n-checkbox-button>
        </n-checkbox-group>
      `,

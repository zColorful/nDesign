...
interface checkboxGroupInjection {
  ...
  beforeChange: undefined | ((isChecked: boolean, v: string | undefined | number | boolean) => boolean | Promise<boolean>);
...
export const checkboxGroupInjectionKey: InjectionKey<checkboxGroupInjection> = Symbol('n-checkbox-group');

...
describe('n-input', () => {
  ...
  it('n-input bindEvents work', async () => {
  ...
  it('n-input disabled work', async () => {
  ...
  it('n-input Method:select/focus/blur work', async () => {
    const testValue = ref('abc');
    const wrapper = mount({
      components: { DInput },
      template: `
        <n-input ref="inputDemo" v-model="testValue" />
      `,
      setup() {
        return {
          testValue,
    ...
    // TODO focus/blur
    // 调用DOM的focus和select并不会给节点的div加上nancalui-input--focus
  });

  it.todo('n-input validate-event work');

  it('n-input prefix/suffix props work', async () => {
    const wrapper = mount({
      components: { DInput },
      template: `
        <n-input prefix="like" suffix="search" />
      `,
    });
  ...
  it('n-input prefix/suffix/prepend/append slot work', async () => {
    const wrapper = mount({
      components: { DInput },
      template: `
        <n-input>
  ...
  it('n-input showPassword work', async () => {
    const wrapper = mount(DInput, {
      props: {
        showPassword: false,
      },
  ...
  it('n-input clearable/clear work', async () => {
    const onClear = jest.fn();
    const wrapper = mount({
      components: { DInput },
      template: `
        <n-input @clear="onTrigger" clearable v-model="value" />
      `,
      setup() {

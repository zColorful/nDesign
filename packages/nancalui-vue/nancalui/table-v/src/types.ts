...
export type HeaderClassGetter<T> = (params: ColumnCommonParams<T> & { headerIndex: number }) => string;
...
export type Columns<T> = ColumnV<T>[];
...
// eslint-disable-next-line @typescript-eslint/ban-types
export type SimpleFunctionalComponent<E extends object = { [key: string]: any }> = FunctionalComponent<SimpleFunctionalComponentProps<E>>;

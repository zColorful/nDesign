...
const { INDEX_FILE_NAME, nancalui_DIR, WHITE_LIST_READY_COMPONENTS } = require('./constant');
...
const parseComponentInfo = (name) => {
  ...
  const indexContent = fs.readFileSync(resolve(nancalui_DIR, name, INDEX_FILE_NAME), { encoding: 'utf-8' });

...
exports.nancalui_DIR = resolve(this.CWD, 'nancalui');
exports.nancalui_NAMESPACE = 'n';
exports.CSS_CLASS_PREFIX = 'nancalui';
exports.TESTS_DIR_NAME = '__tests__';
exports.INDEX_FILE_NAME = 'index.ts';
exports.DOCS_FILE_NAME = 'index.md';
exports.VUE_nancalui_IGNORE_DIRS = ['shared', 'style', 'locale'];
exports.VUE_nancalui_FILE_NAME = 'vue-nancalui.ts';
exports.VUE_nancalui_FILE = resolve(this.nancalui_DIR, this.VUE_nancalui_FILE_NAME);
...
exports.VITEPRESS_SIDEBAR_CATEGORY = ['通用', '导航', '反馈', '数据录入', '数据展示', '布局','复合组件'];
exports.VITEPRESS_SIDEBAR_CATEGORY_EN = ['General', 'Navigation', 'Feedback', 'Data Entry', 'Data Display', 'Layout','Composite component'];

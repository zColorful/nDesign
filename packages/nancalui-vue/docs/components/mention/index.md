...
<template>
  <div class="demo-spacing">
    <n-mention :suggestions="suggestions" @select="handleSelect"></n-mention>
  </div>
</template>
...
<template>
  <div class="demo-spacing">
    <n-mention :suggestions="suggestions" :trigger="triggers"></n-mention>
  </div>
</template>
...
<template>
  <div class="demo-spacing">
    <n-mention :suggestions="suggestions" :loading="loading" @change="onSearchChange"></n-mention>
  </div>
</template>
...
<template>
  <div class="demo-spacing">
    <n-mention :suggestions="suggestions" position="top"></n-mention>
  </div>
</template>
...
<template>
  <div class="demo-spacing">
    <n-mention :suggestions="suggestions" :dmValueParse="{ value: 'name', id: 'id' }">
      <template #template="{ item }">
        <n-avatar style="text-align: right" :name="item.name" :width="18" :height="18"></n-avatar>

...
import { ThemeServiceInit, infinityTheme, provenceTheme, sweetTheme, deepTheme, galaxyTheme } from 'nancalui-theme';
...
import enUS from '@nancalui/locale/lang/en-us';
import zhCN from '@nancalui/locale/lang/zh-cn';
      ...
      <div class="flex items-center">
        ...
        <div class="custom-nav flex items-center ml-l">
          ...
          <a
            ...
            href="https://github.com/DevCloudFE/vue-nancalui"
            target="_blank"
          >
            <svg viewBox="0 0 20 20" width="18" height="18">
              <path
                fill="var(--nancalui-text, #252b3a)"
...
.nav-bar {
  ...
  align-items: center;
  // border-bottom: 1px solid $nancalui-dividing-line;
